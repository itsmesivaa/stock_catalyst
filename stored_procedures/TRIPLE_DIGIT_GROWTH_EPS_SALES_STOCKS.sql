...
Stocks EPS with triple digit growth on Current vs Previous period
Stocks Sales with triple digit growth on Current vs Previous period
*/
CREATE PROCEDURE [dbo].[TRIPLE_DIGIT_GROWTH_EPS_SALES_STOCKS]
AS
BEGIN
	...
	FROM EPS_SALES_calc
	WHERE earn_rownum = 1
		AND [Cur_vs_Prev_EPS%_Diff] > 100
		AND [Cur_vs_Prev_Sales%Diff] > 100
		--AND Promoters > 40  
